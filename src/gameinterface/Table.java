...
public class Table extends JFrame {
	...
	public static final int[] coordinatesX = { 25, 50, 35, 35, 60, 30, 60, 50, 75, 25, 60, 30, 55, 65, 27, 37, 52, 33, 73, 51,
		43, 68, 44, 24, 67, 25, 70, 64, 29, 46, 35, 25, 64, 53, 71, 47, 26, 68, 35, 57, 23, 45, 67, 31, 56, 68, 71,
		43, 68, 44, 24, 67, 25, 70, 64, 29, 46, 35, 25, 64, 53, 71, 47, 26, 68, 35, 57, 23, 45, 67};

	public static final int[] coordinatesY = { 65, 35, 45, 60, 50, 29, 47, 76, 46, 56, 34, 40, 35, 33, 45, 76, 25, 34, 59, 47,
		38, 68, 52, 67, 43, 28, 36, 57, 73, 56, 39, 47, 61, 26, 47, 57, 53, 74, 29, 55, 24, 30, 60, 50, 75, 25, 60,
		38, 68, 52, 67, 43, 28, 36, 57, 73, 56, 39, 47, 61, 26, 47, 57, 53, 74, 29, 55, 24, 30, 60, 50 };
...
//        private int[] coordinatesY = new int[70];
	...
	public void setStoneColor(Color color) {
		...
		for (Box box : boxs) {
			if (box != null) {
				box.currentColor = color; // update color of each existing box
			}
		}
	}
