...
public class Table extends JFrame {
	...
	public void createBanco() {
		...
		boxs[12] = new Box(X + 3 * WIDTH - 50, (int) (boxY + 0 * HEIGHT), WIDTH, HEIGHT, squares[12].getViTri(),
				squares[12].getGiatri(), squares[12].isQuan(),false);
		boxs[13] = new Box(X + 3 * WIDTH - 50, (int) (boxY - 5 * HEIGHT), WIDTH, HEIGHT, squares[13].getViTri(),
